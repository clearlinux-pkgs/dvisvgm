...
Source0  : https://github.com/mgieseki/dvisvgm/releases/download/3.2.2/dvisvgm-3.2.2.tar.gz
...
%prep
%setup -q -n dvisvgm-3.2.2
cd %{_builddir}/dvisvgm-3.2.2
pushd ..
cp -a dvisvgm-3.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709824774
