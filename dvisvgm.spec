...
Version  : 2.14
Release  : 16
URL      : https://github.com/mgieseki/dvisvgm/releases/download/2.14/dvisvgm-2.14.tar.gz
Source0  : https://github.com/mgieseki/dvisvgm/releases/download/2.14/dvisvgm-2.14.tar.gz
...
%prep
%setup -q -n dvisvgm-2.14
cd %{_builddir}/dvisvgm-2.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660314200
...
cp %{_builddir}/dvisvgm-%{version}/libs/ff-woff/LICENSE %{buildroot}/usr/share/package-licenses/dvisvgm/f13242fd2b6974c2940761a97937b4918c5fa4e6
