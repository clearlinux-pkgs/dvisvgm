...
Version  : 3.0.1
Release  : 17
URL      : https://github.com/mgieseki/dvisvgm/releases/download/3.0.1/dvisvgm-3.0.1.tar.gz
Source0  : https://github.com/mgieseki/dvisvgm/releases/download/3.0.1/dvisvgm-3.0.1.tar.gz
...
%prep
%setup -q -n dvisvgm-3.0.1
cd %{_builddir}/dvisvgm-3.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673367223
