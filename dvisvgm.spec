...
Version  : 2.13.2
Release  : 13
URL      : https://github.com/mgieseki/dvisvgm/releases/download/2.13.2/dvisvgm-2.13.2.tar.gz
Source0  : https://github.com/mgieseki/dvisvgm/releases/download/2.13.2/dvisvgm-2.13.2.tar.gz
...
%prep
%setup -q -n dvisvgm-2.13.2
cd %{_builddir}/dvisvgm-2.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645635565
...
cp %{_builddir}/dvisvgm-2.13.2/COPYING %{buildroot}/usr/share/package-licenses/dvisvgm/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/dvisvgm-2.13.2/libs/brotli/LICENSE %{buildroot}/usr/share/package-licenses/dvisvgm/c045813a6c514f2d30d60a07c6aaf3603850e608
cp %{_builddir}/dvisvgm-2.13.2/libs/clipper/License.txt %{buildroot}/usr/share/package-licenses/dvisvgm/262180609d130913cbf4aacd89de9e3281fab846
cp %{_builddir}/dvisvgm-2.13.2/libs/ff-woff/LICENSE %{buildroot}/usr/share/package-licenses/dvisvgm/f13242fd2b6974c2940761a97937b4918c5fa4e6
cp %{_builddir}/dvisvgm-2.13.2/libs/variant/LICENSE.md %{buildroot}/usr/share/package-licenses/dvisvgm/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/dvisvgm-2.13.2/libs/woff2/LICENSE %{buildroot}/usr/share/package-licenses/dvisvgm/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/dvisvgm-2.13.2/tests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/dvisvgm/5a2314153eadadc69258a9429104cd11804ea304
%make_install
