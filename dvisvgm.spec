...
Source0  : https://github.com/mgieseki/dvisvgm/releases/download/3.4/dvisvgm-3.4.tar.gz
...
%prep
%setup -q -n dvisvgm-3.4
cd %{_builddir}/dvisvgm-3.4
pushd ..
cp -a dvisvgm-3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721832629
