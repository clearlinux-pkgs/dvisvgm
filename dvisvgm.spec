...
Version  : 3.0.3
Release  : 21
URL      : https://github.com/mgieseki/dvisvgm/releases/download/3.0.3/dvisvgm-3.0.3.tar.gz
Source0  : https://github.com/mgieseki/dvisvgm/releases/download/3.0.3/dvisvgm-3.0.3.tar.gz
...
%prep
%setup -q -n dvisvgm-3.0.3
cd %{_builddir}/dvisvgm-3.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676993973
